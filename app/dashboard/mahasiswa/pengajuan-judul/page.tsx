...
export default function PengajuanJudulPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.judul || !formData.topik || !formData.usulanPembimbing1 || !formData.usulanPembimbing2 || !files.transkrip || !files.ukt || !files.konsultasi) {
      MySwal.fire({
        ...
        text: 'Harap lengkapi semua field yang ditandai dengan *',
      });
      return;
    }
    ...
    try {
      ...
      // Arahkan ke dasbor setelah sukses
      ...
      MySwal.fire({
        ...
        // Setelah pengguna menekan "OK" pada notifikasi error,
  ...
  const dosenList = [
    { id: 1, nama: 'Prof. Dr. Budi Santoso' },
    { id: 2, nama: 'Dr. Anisa Putri, M.Kom.' },
    { id: 3, nama: 'Ahmad Hidayat, S.Kom., M.T.' },
    { id: 4, nama: 'Dr. Rina Marlina, M.Sc.' },
  ];
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end pt-4">
            <button 
              type="submit" 
              disabled={isLoading}
              className="inline-flex items-center gap-2 py-2 px-5 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:bg-blue-300"
            >
